...
Hour = st.slider('Hour', min_value=0, max_value=23, value=12, step=1)
Temperature = st.slider('Temperature', min_value=-10.0, max_value=40.0, value=20.0, step=0.1)
Humidity = st.slider('Humidity', min_value=0, max_value=100, value=50, step=1)
Wind_speed = st.slider('Wind Speed', min_value=0.0, max_value=30.0, value=5.0, step=0.1)
Visibility = st.slider('Visibility', min_value=0, max_value=2000, value=1000, step=10)
Dew_point = st.slider('Dew Point', min_value=-10.0, max_value=30.0, value=10.0, step=0.1)
Solar_radiation = st.slider('Solar Radiation', min_value=0.0, max_value=3.0, value=1.0, step=0.1)
Rainfall = st.slider('Rainfall', min_value=0.0, max_value=100.0, value=0.0, step=0.1)
Snowfall = st.slider('Snowfall', min_value=0.0, max_value=50.0, value=0.0, step=0.1)
IsHoliday = st.selectbox('Is Holiday', [0, 1])
IsFunctioningDay = st.selectbox('Is Functioning Day', [0, 1])
...
dow = st.slider('Day of week', min_value=0, max_value=6, value=3, step=1)
Season_Autumn = st.selectbox('Season_Autumn', [0, 1])
Season_Spring = st.selectbox('Season_Spring', [0, 1])
Season_Summer = st.selectbox('Season_Summer', [0, 1])
Season_Winter = st.selectbox('Season_Winter', [0, 1])
...
st.write(linha)
previsto = rf.predict(linha)**2
previsto_int = int(previsto[0])
st.write(f'Number of expected rented bikes: {previsto_int}')
