...
st.markdown("The results show that the regression models performed increasingly better, with the Random Forest Regressor performing the best, with a MAE of 1.74, MSE of 7.55 and an R2 Score of 0.95. These values indicate that Random Forest Regressor was able to accurately predict the number of bicycles rented based on the variables in the dataset. Linear regression and Decision Tree Regressor models showed intermediate performances, with R2 Scores of 0.68 and 0.89, respectively. In general, these results indicate that regression models are able to predict the number of bicycles rented with good accuracy based on the variables available in the dataset.")
